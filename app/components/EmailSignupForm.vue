<template>
  ...
  >
    ...
    />
    <button
      class="absolute right-2 top-2 bottom-2 bg-brand-charcoal text-brand-cream rounded-full w-12 h-12 flex items-center justify-center hover:bg-black transition-colors shadow-md disabled:opacity-50"
      type="submit"
